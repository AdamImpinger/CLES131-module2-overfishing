...
There are multiple reasons this helps, the simplest of those being the ability to view the unit used in the timeseries table. The "tsvalue" column is unitless, and when joined, there is another column that displays the unit. Joining these tables links analysis to the population it is describing, creating a more comprehensive picture of the stocks being analyzed and contextualizing how these stocks have changed from the time series data.
