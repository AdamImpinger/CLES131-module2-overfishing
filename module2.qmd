...
-   Briefly describe the contents of each joined table.
    ...
    The joined bioparams, which are summary statistics representing the health of the stocks was combind with biometics to provide a detailed life history of each stock.

    #CAN I GET A REVEIW HERE EVAN

-   What is accomplished by joining these tables?

    Joining these tables links analysis to the population it is describing in r, creating a more comprehensive of the stocks being analyzed and contextualizing how these stocks have changed fromt he time series data
